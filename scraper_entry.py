import av
import torchvision
from vid_dataset_file import VidDataset

file = '/home/ubuntu/padded_ims/train/Hugging/Children_Handshake_GIF_by_Jason_Clarke.mp4'
reader = torchvision.io.read_video(file)
